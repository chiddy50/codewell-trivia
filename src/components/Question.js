                ...
                <div className="w-3/4 fireworks-container question__box">
                    <div className="question my-8 scaleIn">
                        <div className="flex justify-between text-center mb-8">
                            ...
                            <span style={{ color: darkMode ? '#545454' : '#b91372' }} className='text-md mx-3 py-2 px-10 rounded-lg bg-white font-bolder text-center'>Time Remaining: {seconds > 9 ? seconds : `0${seconds}`}:00</span>
